...
class RiotTimelineParser:
    ...
    def __init__(self, api_key: str, routing: str = "americas", 
                 matches_per_player: int = 20, output_dir: str = "timeline_data",
...
def main():
    ...
    players_df = pd.read_csv('opgg_leaderboard.csv')
    
    # Initialize parser
    parser = RiotTimelineParser(
        api_key="RGAPI-6b41f36d-67bb-4648-8d64-35f0842f6c06",
        routing="americas",
        matches_per_player=5,  # Start with fewer matches for testing
        output_dir="timeline_data",
        delay_between_requests=0.2  # Be respectful with rate limits
    )
