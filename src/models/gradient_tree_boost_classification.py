#!/usr/bin/env python3
"""
Gradient Boosting Classifier for League of Legends match prediction
...
OUTPUT_DIR = "results/Model_GradientBoostTree_Classification"

# Create output directory
os.makedirs(OUTPUT_DIR, exist_ok=True)

print("\n" + "="*60)
print("GRADIENT BOOSTING CLASSIFIER - WIN PREDICTION")
print("="*60)
...
axes[0].set_title(f'ROC Curve - Test Set (Frame {PREDICTION_FRAME_IDX})', fontsize=14, fontweight='bold')
...
axes[1].set_title(f'Confusion Matrix - Test Set (Frame {PREDICTION_FRAME_IDX})', fontsize=14, fontweight='bold')
axes[1].set_xticklabels(['Lose (0)', 'Win (1)'])
axes[1].set_yticklabels(['Lose (0)', 'Win (1)'])

plt.tight_layout()
plt.savefig(f'{OUTPUT_DIR}/gradient_boosting_classification_results_frame{PREDICTION_FRAME_IDX}.png', 
            dpi=300, bbox_inches='tight')
print(f"✓ Visualization saved as '{OUTPUT_DIR}/gradient_boosting_classification_results_frame{PREDICTION_FRAME_IDX}.png'")
